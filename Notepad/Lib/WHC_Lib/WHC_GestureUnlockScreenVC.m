...
#define KWHC_inputOldPswLabTxt       (@"Please enter your old password")
#define KWHC_inputNewPswLabTxt       (@"Please enter a new password")
#define KWHC_inputOldGestureLabTxt   (@"Please enter the old hand signal")
#define KWHC_inputNewGestureLabTxt   (@"Please enter a new gesture")

#define KWHC_InputPswLabTxt          (@"Please enter your password")        //输入密码标签文字
#define KWHC_InputPswLabAgTxt        (@"Please enter your password")     //输入密码标签文字
#define KWHC_InputPswLabReTxt        (@"Please enter your password")     //输入密码标签文字
#define KWHC_InputPswLabGestureTxt   (@"Please input the gesture")         //输入密码标签文字
#define KWHC_InputPswLabGestureAgTxt (@"Please enter the gesture again")      //输入密码标签文字
#define KWHC_InputPswLabGestureReTxt (@"Please re-enter your gestures")      //输入密码标签文字
#define KWHC_UnlockSuccessTxt        (@"Entering system")       //解锁成功提示
#define KWHC_SetUnlockSuccessTxt     (@"Set password success")       //解锁成功提示
#define KWHC_DelBtnTxt               (@"Delete")             //删除按钮文字
#define KWHC_CancelBtnTxt            (@"Cancel")             //取消按钮文字
